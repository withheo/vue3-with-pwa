  ...
  var A = URL.createObjectURL(new Blob(['\n\tclass AudioOutputProcessor extends AudioWorkletProcessor {\n\t\tprocess(inputs, outputs) {\n\t\t\tthis.port.postMessage(inputs[0]);\n\t\t\treturn true;\n\t\t}\n\t}\n\n\tregisterProcessor("audio-output-processor", AudioOutputProcessor);\n'],{
    ...
    , C = function() {
      ...
      r = [{
          key: "useAudioWorklet",
          value: function() {
             console.error('useAudioWorklet check ...', P && !this.options.forceScriptProcessor)
          ...
          value: function(t) {
                console.error("createOutputNode")
              var e = this;
              ...
              console.error("this.outputNode ",this.outputNode),
              this.outputNode.port.onmessage = function(t) {
                console.warn(" this.outputNode.port message")
                  var r = t.data;
          ...
          value: function(t) {
              console.error("createAudioNodes")
              ...
              return y().wrap((function(t) {
                  ...
                  for (; ; )
                      ...
                      case 14:
                          ...
                          return t.next = 20,
                          console.log("add asldkfjasldkfj ", A),
