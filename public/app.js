...
import createLinkFromAudioBuffer from './lib/recorder/exporter.js';
//import Waveform from './lib/recorder/waveform.js';
// import VUMeter from './lib/recorder/vumeter.js';
...
async function setupRecordingWorkletNode(recordingProperties) {
  await context.audioWorklet.addModule('./lib/recorder/recording-processor.js');
